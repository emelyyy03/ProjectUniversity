...
public class UserDAO {
    ...
    public User create(User user) throws SQLException {
        ...
        try{
            ...
            ps.setString(2, user.getEmail()); // Asignar el correo electrónico del usuario.
            ps.setString(3, PasswordHasher.hashPassword(user.getPasswordHash())); // Hashear la contraseña antes de guardarla.
            ps.setString(4, user.getRol()); //Asignar un rol al usuario
            ps.setDate(5, user.getFecha_creacion()); //Asigna una fecha de creacion del usuario
            ps.setDate(6, user.getFecha_act()); //Asigna fecha de atulizacion del usuario
    ...
    public boolean update(User user) throws SQLException{
        ...
        try{
            ...
            ps.setString(3, user.getRol()); //Asigna el rol al usuario
            ps.setDate(4, user.getFecha_act()); //Fecha de actualizacion del registro
    ...
    public ArrayList<User> search(String name) throws SQLException{
        ...
        try {
            ...
            while (rs.next()){
                ...
                user.setRol(rs.getString(4));   // Obtener el rol del usuario.
                user.setFecha_creacion(rs.getDate(5));//Obtener la fecha de creacion el usuario
                user.setFecha_act(rs.getDate(6));
    ...
    public User getById(int id) throws SQLException{
        ...
        try {
            ...
            if (rs.next()) {
                ...
                user.setEmail(rs.getString(3));  // Obtener el correo electrónico del usuario.
                user.setRol(rs.getString(4));    // Obtener el Rol del usuario.
                user.setFecha_creacion(rs.getDate(5));//Obtener la fecha de creacion del usuario
                user.setFecha_act(rs.getDate(6)); //Obtener la fecha de actualizacion del usuario
            } else {
    ...
    public User authenticate(User user) throws SQLException{
        ...
        try {
            ...
            if (rs.next()) {
                ...
                userAutenticate.setRol(rs.getString(4));    // Obtener el rol del usuario autenticado.
            } else {
