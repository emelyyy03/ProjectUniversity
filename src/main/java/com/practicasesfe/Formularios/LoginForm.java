...
public class LoginForm extends JDialog{
    ...
    private FormularioPrincipal mainForm; // Declaración de una variable de instancia llamada 'mainForm' de tipo MainForm. Esta variable  representa la ventana principal de la aplicación y se utiliza para interactuar con ella (por ejemplo, para pasar información del usuario autenticado).

    public LoginForm(FormularioPrincipal mainForm){
        ...
        setLocationRelativeTo(mainForm.getRootPanel()); // Centra la ventana de inicio de sesión  relativa al formulario principal ('mainForm').
    ...
    private void login() {
        try{
            ...
            user.setPasswordHash(new String(txtPass.getPassword())); // Obtiene la contraseña ingresada en el campo de contraseña 'txtPassword' (como un array de caracteres), la convierte a un String y la establece como la contraseña hasheada del objeto 'user'.
